...
export default function EditDeviceModal({ open, device, onClose, onSubmit, loading }) {
  const [form, setForm] = useState({
    deviceName: "", deviceType: "RobotArm", robotType: "Unity",
  ...
  useEffect(() => {
    if (device) {
      setForm({
        ...
        deviceType: device.deviceType || "RobotArm",
        robotType: device.robotType || "Unity",
        model: device.model || "",
