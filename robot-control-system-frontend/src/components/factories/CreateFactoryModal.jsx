...
export default function CreateFactoryModal({ open, onClose, onSubmit, loading }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-neutral-950 p-5">
        <div className="flex items-start justify-between gap-3">
          <div>
            <div className="text-white font-semibold">Create Factory</div>
            <div className="text-sm text-white/60 mt-1">Enter factory information</div>
          </div>
        ...
        <div className="mt-4 space-y-3">
          <label className="block">
            ...
            <input
              ...
              placeholder="e.g. Nhà máy Bảo Ân"
            />
          </label>
          <label className="block">
